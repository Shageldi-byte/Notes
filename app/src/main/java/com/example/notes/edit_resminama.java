...
public class edit_resminama extends AppCompatActivity {
    ResminamaDB mydb;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        listView.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                ...
                Intent intent=new Intent(edit_resminama.this,update_resminama.class);
                intent.putExtra("id",s);
                intent.putExtra("resminama",arrayList2.get(position));
    ...
    public void onBackPressed() {
        finish();
        startActivity(new Intent(edit_resminama.this,Main3Activity.class));
    }
}
