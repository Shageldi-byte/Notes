...
public class Hasabatlar_Statistika extends AppCompatActivity {
    String id,result;
    DataBaseHelper mydb;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_hasabatlar__statistika);
        ...
        if(id.equals("1")){
            ...
            umumy_girdeyji_mocberi.setText("Täze girdeýji möçberi: "+girdeyji_moc+" sany karopka");
            umumy_girdeyji_pul.setText("Täze girdeýji pul: "+girdeji_pul+" manat");
            umumy_galyndy_mocberi.setText("Täze galyndy möçberi: "+galyndy_moc+" sany karopka");
            umumy_galyndy_pul.setText("Täze galyndy pul: "+galyndy_pul+" manat");
...
//                        }
            ...
            umumy_harytlar.setText("Täze satylan harytlar: \n"+sony);
